...
import fetchLookupData from '@salesforce/apex/VisitManagementForm.fetchLookupData';

const DELAY = 300;
export default class ContactVisitCustomLookup extends LightningElement {
      @api recordId;
     // public properties with initial default values 
    @api label = ' ';
    @api placeholder = 'search...'; 
    @api iconName = 'standard:opportunity';
    @api sObjectApiName = 'BiomatiQ_Lead__c';
    @api defaultRecordId = '';
    // private properties 
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName',recordId:'$recordId'})
     searchResult(value) {

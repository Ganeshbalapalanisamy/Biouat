...
export default class SubCategoryNewProductForm extends NavigationMixin(LightningElement) {
  ...
  prodIdVal;
    ...
    connectedCallback(){
//alert(this.recordId)
fetchSigngleCategoryData({subCategory:this.recordId})
    .then((result)=>{
        console.log(JSON.stringify(result));
       result.Brand_Name__c?this.brandName=result.Brand_Name__c:this.brandName='';
       this.handlefetchSubCategoryData(true);
        ...
        nameCmp.reportValidity();
         ...
         if(this.type=='Goods'){
             if(this.hsnValueText && /^\d+$/.test(this.hsnValueText)){
                ...
                alert('Please enter valid input in the HSN code ');
                ...
                if(this.sacValue && /^\d+$/.test(this.sacValue)){
                    ...
                    alert('Please enter valid input in the SAC code ');  
                    }
            }
...
this.brandName=event.target.value;
   ...
   this.handlefetchSubCategoryData();

}
handlefetchSubCategoryData(e){
...
if(e==true){
this.SubCategoryVal=this.recordId;
       this.subcategory=this.recordId;
      this.handlefetchSigngleCategoryData();
}
    }).catch(error=>{
...
handlefetchSigngleCategoryData(){
